...
<div class="nav-wrapper">
    ...
    <ul class="right hide-on-med-and-down">
        ...
        <li><a class="white-text" href="experience.html">Activities</a></li>
...
<li><a href="experience.html">Activities</a></li>
...
<footer class="webintern-footer">
    <div class="footer-left">
      ...
      <a href="https://www.linkedin.com/in/prakash-r-8962701ba" class="linkedin sub-footer-icon">
          <i class="fab fa-linkedin"></i>
        </a>
        <a href="https://github.com/prakash100st" class="git sub-footer-icon">
          <i class="fab fa-github"></i>
        </a>
        <a href="https://twitter.com/Prakash_r10?s=08" class="twitter sub-footer-icon">
          <i class="fab fa-twitter"></i>
        </a>
        
            <a href="https://www.instagram.com/invites/contact/?i=1hx4pi61dq9yr&utm_content=40g3xyh" class="instagram sub-footer-icon">
